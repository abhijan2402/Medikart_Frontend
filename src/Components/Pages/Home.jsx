...
export const Home = () => {
    ...
    const verifyCookie = async () => {
      ...
      if (status) {
        ...
        const fullUserData = await axios.get(
          `https://api.prabhatanvik.shop/patient/myInfo/${user}`
        );
  ...
  //     if (username) {
  //       console.log("in2");
  //       const { data } = await axios.get(`https://api.prabhatanvik.shop/patient/myInfo/${username}`);
  //       setFullUser(data);
  ...
  const addAddress = async () => {
    try {
      ...
      const response = await axios.post(
        `https://api.prabhatanvik.shop/patient/addDeliveryAddress/${username}`,
        { address: newAddress },
        { withCredentials: true }
      );
  ...
  const handleChangePass = async () => {
    ...
    try {
      const response = await axios.post(
        "https://api.prabhatanvik.shop/changePassword",
        data,
        {
          withCredentials: true,
        }
