              ...
              <MDBCol lg={"6"} md="12" sm={"12"} className="d-none d-md-block">
                <MDBCardBody className="text-black d-flex flex-column justify-content-center">
                  ...
                  <MDBInput
                    wrapperClass="mb-4"
                    label="Email"
                    placeholder="pillstack@example.com"
                    size="lg"
                    id="form4"
                    type="email"
                    name="email"
                ...
                <MDBCardBody className="text-black d-flex flex-column justify-content-center">
                  ...
                  <MDBRow>
                    <Select
                      ...
                      placeholder={`${formData.EmergencyContact_Name}'s Relation to you`}
                      onChange={onChange}
                    >
                  ...
                  <MDBInput
                    ...
                    placeholder={`${formData.EmergencyContact_Name}'s phone number`}
                    size="lg"
                    id="form4"
                    type="number"
                    onChange={onChange}
